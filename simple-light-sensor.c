/* First Arduino Light Sensor. Based on https://www.instructables.com/Better-LED-as-light-sensor/ */
...
/* these are the values to play with to get better (or worse) results */
